...
// NOTE: `SignInPage` encapsulates reusable logic for this module.
        ...
        <div className='grid w-full gap-5 rounded-xl border border-white/20 bg-white/10 p-4 shadow-2xl backdrop-blur-md sm:gap-6 sm:rounded-2xl sm:p-6 md:grid-cols-2 md:gap-8 md:p-10'>
          <section className='order-2 flex flex-col gap-4 text-white md:order-1 md:gap-5'>
            ...
            <Breadcrumb>
              <BreadcrumbList className='text-slate-200'>
                ...
                <BreadcrumbItem>
                  <BreadcrumbPage className='text-white'>Sign in</BreadcrumbPage>
                </BreadcrumbItem>
              </BreadcrumbList>
            </Breadcrumb>
            ...
            <h1 className='text-2xl font-semibold tracking-tight sm:text-3xl'>Sign in to continue</h1>
            <p className='max-w-md text-sm text-slate-200'>Access Learn Board, save your study input, and run your exercise flow.</p>
          ...
          <section className='order-1 flex items-center justify-center md:order-2'>
            <div className='w-full max-w-sm'>
              <SignIn routing='path' path='/sign-in' signUpUrl='/sign-up' forceRedirectUrl='/' appearance={clerkAppearance} />
            </div>
          </section>
        </div>
      </div>
